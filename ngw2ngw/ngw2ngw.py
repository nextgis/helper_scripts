...
if __name__ == '__main__':
    ...
    cfg=dict()
    cfg['1ngw_url'] 		= config.1ngw_url
    cfg['1ngw_resource_id']	= config.1ngw_resource_id
    cfg['1ngw_creds']		= config.1ngw_ceds


    cfg['2ngw_url'] 		= config.2ngw_url
    cfg['2ngw_resource_id']	= config.2ngw_resource_id
    cfg['2ngw_creds']		= config.2ngw_ceds
    ...
    dump1new=processor.dumpLayer(layer1)
