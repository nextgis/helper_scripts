...
for i in items[1:]:
    if i[2] == 'aerialway-point' or i[2] == 'aerialway-line' or i[2] == 'public-transport-point' or i[2] == 'parking-polygon' or i[2] == 'highway-crossing-point' or i[2] == 'public-transport-line':
