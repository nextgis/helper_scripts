...
vrt не поддерживает объединение растров в разных сисемах координат, поэтому пердварительно перепроецируйте свои растры в EPSG:3857 в batch_reproject.py
