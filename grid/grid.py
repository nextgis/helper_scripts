...
# More: https://github.com/nextgis/helper_scripts
#
# Example:
#      python  grid.py --step 100 --mode rect bounds.geojson grid.gpkg 
#
...
def get_args():
    ...
    p.add_argument('--clip',required=False,choices=['all', 'intersection','touches'], default = 'intersection',help="Grid clipping mode. \n all: grid in extent of each boundary feature. \n touches: leave features intersects or overlaps with boundary \n intersection: intersect grid by boundary")
...
def process():
    ...
    if mode == 'rect':
        outLayer = outDataSource.CreateLayer(outputGridfn,wgs1984SpatialRef,geom_type=ogr.wkbMultiPolygon)
    elif mode == 'point':
    ...
    for i in range(0, inLayer.GetFeatureCount()):
        ...
        while countcols < cols:
            ...
            while countrows < rows:
                ...
                #clip_operator = 'touches' #all, touches, intersection
